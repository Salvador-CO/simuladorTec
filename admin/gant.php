...
<html>
    <head>
        ...
        <link href="https://cdn.datatables.net/1.10.20/css/dataTables.bootstrap4.min.css" rel="stylesheet" crossorigin="anonymous" />         <title>Diagrama Gantt</title>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11.2/js/all.min.js" crossorigin="anonymous"></script>


         <!--Librerias Gantt-->
          <link rel=stylesheet href="librerias/gant/platform.css" type="text/css">
          <link rel=stylesheet href="librerias/gant/libs/jquery/dateField/jquery.dateField.css" type="text/css">

          <link rel=stylesheet href="librerias/gant/gantt.css" type="text/css">
          <link rel=stylesheet href="librerias/gant/ganttPrint.css" type="text/css" media="print">
          <link rel=stylesheet href="librerias/gant/libs/jquery/valueSlider/mb.slider.css" type="text/css" media="print">

          <script src="http://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
          <script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script>

          <script src="librerias/gant/libs/jquery/jquery.livequery.1.1.1.min.js"></script>
          <script src="librerias/gant/libs/jquery/jquery.timers.js"></script>

          <script src="librerias/gant/libs/utilities.js"></script>
          <script src="librerias/gant/libs/forms.js"></script>
          <script src="librerias/gant/libs/date.js"></script>
          <script src="librerias/gant/libs/dialogs.js"></script>
          <script src="librerias/gant/libs/layout.js"></script>
          <script src="librerias/gant/libs/i18nJs.js"></script>
          <script src="librerias/gant/libs/jquery/dateField/jquery.dateField.js"></script>
          <script src="librerias/gant/libs/jquery/JST/jquery.JST.js"></script>
          <script src="librerias/gant/libs/jquery/valueSlider/jquery.mb.slider.js"></script>

          <script type="text/javascript" src="librerias/gant/libs/jquery/svg/jquery.svg.min.js"></script>
          <script type="text/javascript" src="librerias/gant/libs/jquery/svg/jquery.svgdom.1.8.js"></script>


          <script src="librerias/gant/ganttUtilities.js"></script>
          <script src="librerias/gant/ganttTask.js"></script>
          <script src="librerias/gant/ganttDrawerSVG.js"></script>
          <script src="librerias/gant/ganttZoom.js"></script>
          <script src="librerias/gant/ganttGridEditor.js"></script>
          <script src="librerias/gant/ganttMaster.js"></script>  
    ...
    <?php require "menuadmin.php" ?>
        ...
        <div class="container-fluid" >
            <center><h1 class="mt-4" color="black">Diagrama de Gantt <button type="button" class="btn btn-info btn-circle" data-toggle="modal" data-target="#btnPrueba" title="¡Da clic para obtener mas información!"><i class="fas fa-question"></i> </button> </h1></center>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active" style="text-align: justify;">
                <b> Instrucciones:</b> Diseñar el diagrama de Gantt donde se muestre la administración del tiempo de las  diferentes tareas o actividades para el logro del proyecto establecido en el Reactivo Integrador Multidisciplina (RIM). Así mismo, al terminar de realizar tu ejercicio deberás descargarlo en formato PDF para posteriormente poder subirlo en el apartado “Carga de archivos”.</li>
        </ol>
        ...
        <div id="btnPrueba" class="modal fade" style="z-index: 1400;" data-target="#btnPrueba">
            ...
            <div class="modal-content">
                <div style="background: #1B396A; color: #fff; height: 75px;padding-left: 40px;">
                        <p><h1 class="modal-title col-11 text-center">Ayuda</h1></p>
                </div>
...
<div class="__template__" type="GANTBUTTONS">
  ...
  <div class="ganttButtonBar noprint">
    <div class="buttons">
     <img src="librerias/gant/res/img.png" alt="Twproject" align="absmiddle" width="50px" height="50px">
    ...
    <div>
      <br>
      <button onclick='newProject();' class='button requireWrite newproject'><em>Limpiar Proyecto</em></button>
...
<div class="__template__" type="TASKSEDITHEAD">
 <!-- <table class="gdfTable" cellspacing="0" cellpadding="0">
    ...
    <tr style="height:40px">
      ...
      <th class="gdfColHeader gdfResizable" style="width:50px;">Inicio</th>
      ...
      <th class="gdfColHeader gdfResizable" style="width:50px;">Fin</th>
      <th class="gdfColHeader gdfResizable" style="width:50px;">Duración.</th>
      <th class="gdfColHeader gdfResizable" style="width:20px;">%</th>
      <th class="gdfColHeader gdfResizable requireCanSeeDep" style="width:50px;">Dependecia.</th>
      <th class="gdfColHeader gdfResizable" style="width:1000px; text-align: left; padding-left: 10px;">Encargado.</th>
    </tr>
    </thead>
  </table>-->
  </div>
...
<div class="__template__" type="TASK_EDITOR">
  <div class="ganttTaskEditor">
    <h2 class="taskData">Editor de tareas</h2>
    <table  cellspacing="1" cellpadding="5" width="100%" class="taskData table" border="0">
      ...
      <tr>
        <td  colspan="2">
          <label for="status" class=" ">Estado</label><br>
          <select id="status" name="status" class="taskStatus" status="(#=obj.status#)"  onchange="$(this).attr('STATUS',$(this).val());">
            <option value="STATUS_ACTIVE" class="taskStatus" status="STATUS_ACTIVE" >Activo</option>
            <option value="STATUS_WAITING" class="taskStatus" status="STATUS_WAITING" >Suspedido</option>
            <option value="STATUS_SUSPENDED" class="taskStatus" status="STATUS_SUSPENDED" >Pausado</option>
            ...
            <option value="STATUS_UNDEFINED" class="taskStatus" status="STATUS_UNDEFINED" >Idefiido</option>
          </select>
        </td>
...
$(document).on("change", "#load-file", function() {
  ...
  upload(uploadedFile);
        ...
        <script src="https://code.jquery.com/jquery-3.4.1.min.js" crossorigin="anonymous"></script>   CHOCA CON DIAGRAMA DE GANTT-->
        <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
        <script src="../js/scripts.js"></script> <!--Responsivo menu -->
