...
<html>
	...
	<?php require "menuadmin.php" ?>
		...
		<div class="container-fluid">
	    	<center><h1 class="mt-4">Árbol de Decisiones <button type="button" class="btn btn-info btn-circle" data-toggle="modal" data-target="#btnPrueba" title="¡Da clic para obtener mas información!"><i class="fas fa-question"></i> </button> </h1></center>
	    	<br>
	    <ol class="breadcrumb mb-4">
	        <li class="breadcrumb-item active" style="text-align: justify;">
                <b> Instrucciones:</b> Utilizar la herramienta del árbol de decisiones para evaluar las alternativas que muestra  el Reactivo Integrador Multidisciplina (RIM), y determinar cuál es la opción a través del costo-beneficio. Así mismo, al terminar de realizar tu ejercicio deberás descargarlo en formato PDF para posteriormente poder subirlo en el apartado “Carga de archivos”.</li>
		</ol>
		</div>
        ...
        <div id="btnPrueba" class="modal fade" style="z-index: 1400;" data-target="#btnPrueba">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <embed src="../manual/Árbol.pdf#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf" width="100%" height="600px" />
