...
<html>
	...
	<?php require "menuadmin.php" ?>
		...
		<div class="container-fluid">
	    	<center><h1 class="mt-4">Balanced Score Card <button type="button" class="btn btn-info btn-circle" data-toggle="modal" data-target="#btnPrueba" title="¡Da clic para obtener mas información!"><i class="fas fa-question"></i> </button></h1></center>
        ...
        <div id="btnPrueba" class="modal fade" style="z-index: 1400;" data-target="#btnPrueba">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <embed src="../manual/BSC.pdf#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf" width="100%" height="600px" />
              </div>      
            </div>
          </div>
        </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-secondary text-white mb-4">
                    <div class="card-body">
                        ...
                        <font face="Bookman Old Style, Book Antiqua, Garamond" size="3">Análisis de Balanced Score Card</font>
                    </div>
                    <div class="card-footer d-flex align-items-center justify-content-between" style="background: #365A7F ">
                        <a class="small text-white stretched-link" href="analisisbsc.php">Ver panel</a>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-secondary text-white mb-4">
                    <div class="card-body">
                        ...
                        <font face="Bookman Old Style, Book Antiqua, Garamond" size="4">Diseño de mapa estratégico (BSC)</font>
                    </div>
                    <div class="card-footer d-flex align-items-center justify-content-between" style="background: #365A7F ">
                        <a class="small text-white stretched-link" href="mapaestra.php">Ver panel</a>
                        <div class="small text-white">
                            <i class="fas fa-angle-right" style="color:#fff; width:20; height:20;"></i>
                        </div>
                    </div>
