...
<html>
	...
	<?php require "menuadmin.php" ?>
		...
		<div class="container-fluid">
	    	<center><h1 class="mt-4">Diseño de mapa estrategico (BSC)</h1></center>
	    <ol class="breadcrumb mb-4">
	        <li class="breadcrumb-item active"><b>Instrucciones: </b>Diseñar el mapa estratégico que refleje la estrategia organizacional que incluya las perspectivas establecidas en el Balance Score Card e incluya flechas entre los objetivos para mostrar su relación de causa y efecto. Así mismo, al terminar de realizar tu ejercicio deberás descargarlo en formato PDF para posteriormente poder subirlo en el apartado “Carga de archivos”. </li>
		</ol>
		<!--Contenido dentro del div con margen-->
  	     <h6 align="center"></h6>
        
		  <div class="cont">
            <iframe src="https://simuladorcea.000webhostapp.com/diam/new.html" 
