...
<script type="text/javascript">
    ...
    function main() {
        ...
        if (!mxClient.isBrowserSupported()) {
            ...
            style[mxConstants.STYLE_IMAGE] = 'mxgraph/editors/images/dude3.png';
            ...
            try {
                ...
                var v1 = graph.insertVertex(parent, 'treeRoot',
                    'Organizacion', w / 2 - 30, 20, 140, 60, 'mxgraph/editors/images/house.png');
            ...
            tb.addItem('Zoom In', 'mxgraph/images/zoom_in32.png', function(evt) {
                graph.zoomIn();
            });

            tb.addItem('Zoom Out', 'mxgraph/images/zoom_out32.png', function(evt) {
                graph.zoomOut();
            });

            tb.addItem('Actual Size', 'mxgraph/images/view_1_132.png', function(evt) {
                graph.zoomActual();
            });

            tb.addItem('Print', 'mxgraph/images/print32.png', function(evt) {
                var preview = new mxPrintPreview(graph, 1);
                preview.open();
            });

            tb.addItem('Poster Print', 'mxgraph/images/press32.png', function(evt) {
            ...
            wnd = new mxWindow('Herramientas', content, 100, 100, 200, 66, false);
    ...
    function createPopupMenu(graph, menu, cell, evt) {
        ...
        if (cell != null) {
            if (model.isVertex(cell)) {
                menu.addItem('Add child', 'mxgraph/editors/images/overlays/check.png', function() {
                    addChild(graph, cell);
                });
            }

            menu.addItem('Edit label', 'mxgraph/editors/images/text.gif', function() {
                graph.startEditingAtCell(cell);
            });

            if (cell.id != 'treeRoot' &&
                model.isVertex(cell)) {
                menu.addItem('Delete', 'mxgraph/editors/images/delete.gif', function() {
        ...
        menu.addItem('Fit', 'mxgraph/editors/images/zoom.gif', function() {
            graph.fit();
        });

        menu.addItem('Actual', 'mxgraph/editors/images/zoomactual.gif', function() {
            graph.zoomActual();
        });

        menu.addSeparator();

        menu.addItem('Print', 'mxgraph/editors/images/print.gif', function() {
            var preview = new mxPrintPreview(graph, 1);
            preview.open();
        });

        menu.addItem('Poster Print', 'mxgraph/editors/images/print.gif', function() {
            var pageCount = mxUtils.prompt('Enter maximum page count', '1');
    ...
    function addOverlays(graph, cell, addDeleteIcon) {
        var overlay = new mxCellOverlay(new mxImage('mxgraph/images/add.png', 24, 24), 'Add child');
        overlay.cursor = 'hand';
        ...
        if (addDeleteIcon) {
            overlay = new mxCellOverlay(new mxImage('mxgraph/images/close.png', 30, 30), 'Delete');
            overlay.cursor = 'hand';
...
<body onload="main();">
    ...
    <div id="outlineContainer" style="z-index:1;position:absolute;overflow:hidden;top:80px;right:50px;width:160px;height:120px;background:transparent;border-style:solid;border-color:lightgray;">
    </div>
