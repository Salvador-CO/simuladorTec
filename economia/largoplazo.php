<html>
	...
	<?php require "menueconomia.php" ?>
		...
		<div class="container-fluid">
	    	<center><h1 class="mt-4">Teoria de la produccion a largo plazo</h1></center>
            ...
            <div class="parents">
                ...
                <div class="child">
                    <div class="titu">
                        ...
                        <font face="Bookman Old Style, Book Antiqua, Garamond" size="4vw">Producción con 2 insumos</font>
                    </div>
                    <div class="footer">
                        <a href="largopfunciones.php">Ver panel &nbsp;<i class="fas fa-angle-right" ></i></a>
                    </div>
                </div>
