<html>
	...
	<?php require "menueconomia.php" ?>
		...
		<div class="container-fluid">
	    	<center><h1 class="mt-4">Costos de producion</h1></center>
            ...
            <div class="parents">
                ...
                <div class="child">
                    <div class="titu">
                        ...
                        <font face="Bookman Old Style, Book Antiqua, Garamond" size="4vw">Costos Totales</font>
                    </div>
                    <div class="footer">
                        <a href="costotal.php">Ver panel &nbsp;<i class="fas fa-angle-right" ></i></a>
                    </div>
                </div>
                ...
                <div class="child">
                    <div class="titu">
                        ...
                        <font face="Bookman Old Style, Book Antiqua, Garamond" size="4vw">Costos Promedio</font>
                    </div>
                    <div class="footer">
                        <a  href="costoprom.php">Ver panel &nbsp;<i class="fas fa-angle-right" ></i></a>
                    </div>
                </div>
