    ...
    <div class="grand_parent">
            <div class="parents">
                ...
                <div class="child">
                    <div class="titu">
                        <i class="fas fa-chart-line"style="color:#FFFFFF; width:20; height:20;" ></i> 
                        <font face="Bookman Old Style, Book Antiqua, Garamond" size="4vw">Curvas de indiferencia</font>
                    </div>
                    <div class="footer">
                        <a  href="curvasindiferencia.php">Ver panel &nbsp;<i class="fas fa-angle-right" ></i></a>
                    </div>
                </div>
                ...
                <div class="child">
                    <div class="titu">
                        <i class="fas fa-chart-line"style="color:#FFFFFF; width:20; height:20;" ></i> 
                        <font face="Bookman Old Style, Book Antiqua, Garamond" size="4vw">Elasticidad Ingreso-Demanda</font>
                    </div>
                    <div class="footer">
                        <a  href="elasInDem.php">Ver panel &nbsp;<i class="fas fa-angle-right" ></i></a>
                    </div>
                </div>
                ...
                <div class="child">
                    <div class="titu">
                        <i class="fas fa-chart-line"style="color:#FFFFFF; width:20; height:20;" ></i> 
                        <font face="Bookman Old Style, Book Antiqua, Garamond" size="4vw">Elasticidad Precio-Demanda</font>
                    </div>
                    <div class="footer">
                        <a  href="elasPreDem.php">Ver panel &nbsp;<i class="fas fa-angle-right" ></i></a>
                    </div>
                </div>
            </div>
    </div>
