            ...
            <div class="parents">
                ...
                <div class="child">
                    <div class="titu">
                        ...
                        <font face="Bookman Old Style, Book Antiqua, Garamond" size="5vw">Balanza de pagos</font>
                    </div>
                    <div class="footer">
                ...
                <div class="child">
                    <div class="titu">
                        <i class="fas fa-chart-line"style="color:#FFFFFF; width:25; height:25;" ></i> 
                        <font face="Bookman Old Style, Book Antiqua, Garamond" size="5vw">Tipo de cambio</font>
                    </div>
                    <div class="footer">
                        <a  href="tipo_cambio.php">Ver panel &nbsp;<i class="fas fa-angle-right" ></i></a>
                    </div>
                </div>
