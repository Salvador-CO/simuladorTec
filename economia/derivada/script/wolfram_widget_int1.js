...
WolframAlphaWidget.loadResultIFrame = function(wid,wuid,input ){
	...
	var useOpacity = (navigator.userAgent.indexOf("MSIE")!=-1);
...
(function(){ 
    ...
    if ( typeof(baseCss) === 'undefined' || baseCss === null ){
        ...
        baseCss.href = '//'+oms_s_name+'/skins/default/wolfram_base.css';
