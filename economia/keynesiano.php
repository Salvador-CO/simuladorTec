<html>
	...
	<?php require "menueconomia.php" ?>
		...
		<div class="container-fluid">
	    	<center><h1 class="mt-4">Modelo Keynesiano <button type="button" class="btn btn-info btn-circle" data-toggle="modal" data-target="#btnPrueba"><i class="fas fa-question"></i> </button></h1></center>
		...
		<!--Contenido dentro del div con margen-->
			<iframe width="100%" height="500px" frameborder="0" scrolling="no" src="https://onedrive.live.com/embed?resid=EC0CFE9AF404B4F8%21137&authkey=%21AAXeJWcsgtElrf0&em=2&AllowTyping=True&ActiveCell='Hoja1'!A1&wdHideGridlines=True&wdHideHeaders=True&wdDownloadButton=True&wdInConfigurator=True"></iframe>
			<br><br>
		</div>
