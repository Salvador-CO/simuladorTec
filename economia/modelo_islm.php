<html>
	...
	<?php require "menueconomia.php" ?>
		...
		<div class="container-fluid">
	    	<center><h1 class="mt-4">Modelo IS - LM <button type="button" class="btn btn-info btn-circle" data-toggle="modal" data-target="#btnPrueba"><i class="fas fa-question"></i> </button></h1></center>
            ...
            <div class="modal-dialog modal-lg" role="dialog" >
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                   <!--   contenido -->
                    <embed src="../manual/Modelo.pdf#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf" width="100%" height="600px" />
                  </div>      
                </div>
            </div>
        </div>
