<html>
	...
	<?php require "menueconomia.php" ?>
		...
		<div class="container-fluid" align="center">
	    	<center><h1 class="mt-4">Tipo de cambio <button type="button" class="btn btn-info btn-circle" data-toggle="modal" data-target="#btnPrueba"><i class="fas fa-question"></i> </button></h1></center>
