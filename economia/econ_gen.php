            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-danger text-white mb-4">
                    <div class="card-body">
                        ...
                        <font face="Bookman Old Style, Book Antiqua, Garamond" size="4">Operaciones</font>
                    </div>
                    <div class="card-footer d-flex align-items-center justify-content-between" style="background: #7B241C  ">
                        <a class="small text-white stretched-link" href="operaciones.php">Ver panel</a>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-danger text-white mb-4">
                    <div class="card-body">
                        ...
                        <font face="Bookman Old Style, Book Antiqua, Garamond" size="4">Gráficos</font>
                    </div>
                    <div class="card-footer d-flex align-items-center justify-content-between" style="background: #7B241C  ">
                        <a class="small text-white stretched-link" href="graficos.php">Ver panel</a>
                        <div class="small text-white">
                            <i class="fas fa-angle-right" style="color:#fff; width:20; height:20;"></i>
                        </div>
					</div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-danger text-white mb-4">
                    <div class="card-body">
                        ...
                        <font face="Bookman Old Style, Book Antiqua, Garamond" size="4">Demanda de Prod</font>
                    </div>
                    <div class="card-footer d-flex align-items-center justify-content-between" style="background: #7B241C  ">
                        <a class="small text-white stretched-link" href="demproductos.php">Ver panel</a>
                        <div class="small text-white">
                            <i class="fas fa-angle-right" style="color:#fff; width:20; height:20;"></i>
                        </div>
    				</div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-danger text-white mb-4">
                    <div class="card-body">
                        ...
                        <font face="Bookman Old Style, Book Antiqua, Garamond" size="4">Cálculo de matrices</font>
                    </div>
                    <div class="card-footer d-flex align-items-center justify-content-between" style="background: #7B241C ">
                        <a class="small text-white stretched-link" href="calmatrices.php">Ver panel</a>
                        <div class="small text-white">
                            <i class="fas fa-angle-right" style="color:#fff; width:20; height:20;"></i>
                        </div>
					</div>
