...
<html>
	...
	<?php require "menuconta.php" ?>
		...
		<div class="container-fluid">
	    	<center><h1 class="mt-4">Estado de Situación Financiera</h1><h5>-En forma de reporte-</h5></center>
		...
		<!-- inicio de left -->
			...
			<!-- fin del capital -->
		<!-- fin de left -->
		<center><a href="pdf/reporte.php" target="_blank"> <button  title="Descargar balanza de comprobación.pdf" type="button" class="btn btn-dark"><i class="fa fa-download"></i></button>
	   	</div><!-- fin de conten -->
