...
<html>
	...
	<?php require "menuconta.php" ?>
		...
		<div class="container-fluid">
	    	<center><h1 class="mt-4">Balanza de Comprobación   <button type="button" class="btn btn-info btn-circle" data-toggle="modal" data-target="#btnPrueba"><i class="fas fa-question"></i> </button></h1></center>
