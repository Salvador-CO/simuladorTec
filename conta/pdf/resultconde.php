...
<?php
	...
	// Logo
	    ...
	    $this->SetFont('Arial','B',20);
      	...
      	$this->Cell(200,6,utf8_decode('Estado de Resulrado Condensado'),0,0,'C');
      	$this->Ln(10);
		...
		$this->Cell(144.8,10,'Cuenta', 1, 0, 'C',2);
		$this->Cell(0.1);
		$this->Cell(24.9,10,' ', 1, 0, 'C',2);
		$this->Cell(0.1);
		$this->Cell(24.9,10,' ', 1, 0, 'C',1);
		$this->Ln();
	   ...
	   // tabla
		...
		while ($row=$resultado->fetch_assoc()) {
			$pdf->SetX(10);
				...
				$pdf->Cell(145, 10, utf8_decode($row['cuenta']), 1, 0, 'L',true);
	...
	$pdf->Ln();	
	$pdf->Output('i', 'Estado de Resultado Condensado.pdf');
?>