<html>
	<head>
        ...
        <title>Técnicas de evaluación de proyectos</title>
            ...
            <div class="modal-dialog modal-lg" role="dialog" >
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                   <!--   contenido -->
                    <embed src="../manual/Técnicas.pdf#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf" width="100%" height="600px" />
                  </div>      
                </div>
            </div>
        </div>
    ...
    <!----> 
        ...
        <div class="p">
                <embed src="../anexos/Plantilla_Tecnicas de evaluacion de proyectos.pdf" type="application/pdf" width="85%" height="600px" />
        </div>
    <br>

    <div class="b">
    	<a href="pdf/Plantilla_Tecnicas de evaluacion de proyectos.xlsx" target="_blank"> <button  title="Técnicas de evaluación de proyectos.xlsx" type="button" class="btn btn-dark"><i class="fa fa-download"></i> Descargar plantilla de <br>"Técnicas de evaluación de proyectos"</button> </a>   	
    </div>
    <br><br>
